...
@register_model("smi2struct")
class Smi2StructModel(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
...
@register_model_architecture("smi2struct", "smi2struct")
...
@register_model_architecture("smi2struct", "smi2struct_base")
def unimol_base_architecture(args):
    base_architecture(args)

@register_model_architecture("smi2struct", "smi2struct_150M")
