...
@register_model("unimol_encoder_no_grad")
class UniMolEncoderNoGradModel(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
...
@register_model_architecture("unimol_encoder_no_grad", "unimol_encoder_no_grad")
...
@register_model_architecture("unimol_encoder_no_grad", "unimol_encoder_no_grad_base")
def unimol_base_architecture(args):
    base_architecture(args)

@register_model_architecture("unimol_encoder_no_grad", "unimol_encoder_no_grad_150M")
