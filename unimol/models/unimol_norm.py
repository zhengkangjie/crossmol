...
@register_model("unimol_norm")
class UniMolNormModel(BaseUnicoreModel):
    @staticmethod
    def add_args(parser):
    ...
    def __init__(self, args, dictionary):
        ...
        self.emb_layer_norm_test_fuck_unimol = LayerNorm(args.encoder_embed_dim)
...
@register_model_architecture("unimol_norm", "unimol_norm")
...
@register_model_architecture("unimol_norm", "unimol_norm_base")
def unimol_base_architecture(args):
    base_architecture(args)

@register_model_architecture("unimol_norm", "unimol_norm_150M")
