...
from .uni_transformer_layer import UniTransformerEncoderLayer
...
class UniTransformerEncoder(FairseqEncoder):
    """
    ...
    def build_encoder_layer(self, args):
        layer = UniTransformerEncoderLayer(
    ...
    def forward(
        ...
        return self.forward_scriptable(
            src_tokens, src_lengths, return_all_hiddens, token_embeddings, token_dropout, need_head_weights, return_contacts
        )
