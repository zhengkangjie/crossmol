...
class RotaryMultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = RotaryMultiheadAttention._append_prev_key_padding_mask(
        ...
        attn_weights = RotaryMultiheadAttention.apply_sparse_mask(attn_weights, tgt_len, src_len, bsz)
