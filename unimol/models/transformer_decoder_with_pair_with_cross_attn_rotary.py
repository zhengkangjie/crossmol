...
from .transformer_decoder_layer_with_pair_rotary import TransformerDecoderLayerWithPairRotary

class TransformerDecoderWithPairWithCrossAttnRotary(nn.Module):
    def __init__(
        self,
        ...
        self.layers = nn.ModuleList(
            [
                TransformerDecoderLayerWithPairRotary(
    ...
    def forward(
        ...
        for i in range(len(self.layers)):
            x, attn_mask, _ = self.layers[i](
                ...
                encoder_out=encoder_out, encoder_attn_bias=encoder_attn_bias, encoder_padding_mask=encoder_padding_mask
            )
