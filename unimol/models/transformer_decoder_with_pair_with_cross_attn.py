...
from .transformer_decoder_layer_with_pair import TransformerDecoderLayerWithPair

class TransformerDecoderWithPairWithCrossAttn(nn.Module):
    def __init__(
        self,
        ...
        self.layers = nn.ModuleList(
            [
                TransformerDecoderLayerWithPair(
