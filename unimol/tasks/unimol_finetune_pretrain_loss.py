...
@register_task("mol_finetune_pretrain_loss")
class UniMolFinetunePretrainingLossTask(UnicoreTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--ignore-grad",
            action="store_true",
            help="ignore gradient during training",
        )
    ...
    def load_dataset(self, split, **kwargs):
        ...
        if split == "train":
            task_tgt_dataset = KeyDataset(dataset, "target")
        ...
        nest_dataset = NestedDictionaryDataset(
            {
                ...
                "target": {
                    "finetune_target": RawLabelDataset(task_tgt_dataset),
    ...
    def train_step(
        ...
        if ignore_grad or self.args.ignore_grad:
            loss *= 0
