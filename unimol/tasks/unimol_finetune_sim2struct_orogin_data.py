...
@register_task("mol_finetune_sim2struct_orogin_data")
class UniMolFinetuneSmi2StructOriginDataTask(UnicoreTask):
    ...
    def load_dataset(self, split, **kwargs):
        ...
        tokenize_smi = ListTokenizeDataset(smi_dataset, max_seq_len=self.args.max_source_positions)
        ...
        src_dataset = TokenizeDataset(
            src_dataset, self.atom_dictionary, max_seq_len=self.args.max_seq_len
        )
        ...
        src_dataset = PrependAndAppend(
            src_dataset, self.atom_dictionary.bos(), self.atom_dictionary.eos()
        )
        ...
        smi_src_dataset = PrependAndAppend(
            smi_tokens, self.smi_dictionary.bos(), self.smi_dictionary.eos()
        )
